  ...
  (b[0] = {
    value: function (a, c, d) {
      ...
      f.register("arc", function (a, b, c, d, f) {
        ...
        a.getMinder().getPaper().addResource(g),
          (h = new e.Point(l.cx, l.cy)),
          (i =
            "left" == o
              ? new e.Point(k.right + 2, k.cy)
              : new e.Point(k.left - 2, k.cy)),
          (j = e.Vector.fromPoints(h, i)),
          n.push("M", h),
          n.push("A", m(j.x), m(j.y), 0, 0, j.x * j.y > 0 ? 0 : 1, i),
          c.setMarker(g),
          g.dot.fill(f),
          c.setPathData(n);
      });
    ...
    (b[1] = {
      value: function (a, c, d) {
        ...
        f.register("arc_tp", function (a, b, c, d, f) {
          ...
          h.x, i.x;
          a.getMinder().getPaper().addResource(g),
            (l = new e.Point(i.cx, i.cy)),
            (m = new e.Point(h.cx, h.cy));
          var o = Math.sqrt(Math.pow(l.x - m.x, 2) + Math.pow(l.y - m.y, 2));
          if (
            ((o = 0 == a.getIndex() ? 0.4 * o : o),
            e.Vector.fromPoints(l, m),
            n.push("M", l),
            n.push("A", o, o, 0, 0, 1, m),
            c.setMarker(g),
            g.dot.fill(f),
            c.setPathData(n),
            k && k.getConnection())
          ) {
            var p = k.getConnection(),
              q = k.getLayoutBox(),
              r = new e.Point(q.cx, q.cy),
              s = Math.sqrt(Math.pow(m.x - r.x, 2) + Math.pow(m.y - r.y, 2));
            (n = []),
              n.push("M", m),
              n.push("A", s, s, 0, 0, 1, r),
              p.setMarker(g),
              g.dot.fill(f),
              p.setPathData(n);
          }
    ...
    (b[2] = {
      value: function (a, c, d) {
        b.r(17);
        b.r(11).register("bezier", function (a, b, c) {
    ...
    (b[3] = {
      value: function (a, c, d) {
        b.r(17);
        b.r(11).register("fish-bone-master", function (a, b, c) {
          var d = b.getLayoutVertexOut(),
            e = a.getLayoutVertexIn(),
            f = Math.abs,
            g = f(d.y - e.y),
    ...
    (b[4] = {
      value: function (a, c, d) {
        b.r(17);
        b.r(11).register("l", function (a, b, c) {
          var d = b.getLayoutVertexOut(),
            e = a.getLayoutVertexIn(),
            ...
            i = Math.abs;
          g.push("M", d.round()),
            i(f.x) > i(f.y) ? g.push("H", h(e.x)) : g.push("V", e.y),
            g.push("L", e),
            c.setPathData(g);
        });
      },
    ...
    (b[5] = {
      value: function (a, c, d) {
        b.r(17);
        b.r(11).register("poly", function (a, b, c, d) {
          ...
          switch ((j.push("M", h(e.x), h(e.y)), !0)) {
            case i(g.x) > i(g.y) && g.x < 0:
              j.push("h", -b.getStyle("margin-left")),
                j.push("v", f.y - e.y),
                j.push("H", f.x);
              break;
            case i(g.x) > i(g.y) && g.x >= 0:
              j.push("h", b.getStyle("margin-right")),
                j.push("v", f.y - e.y),
                j.push("H", f.x);
              break;
            case i(g.x) <= i(g.y) && g.y < 0:
              j.push("v", -b.getStyle("margin-top")),
                j.push("h", f.x - e.x),
                j.push("V", f.y);
              break;
            case i(g.x) <= i(g.y) && g.y >= 0:
              j.push("v", b.getStyle("margin-bottom")),
                j.push("h", f.x - e.x),
                j.push("V", f.y);
          }
    ...
    (b[6] = {
      value: function (a, c, d) {
        var e = b.r(17);
        b.r(11).register("under", function (a, b, c, d, f) {
          var g,
            h,
            i,
            j,
          ...
          "right" == n
            ? ((g = new e.Point(l.right, p)),
              (h = new e.Point(k.left - 10, o)),
              (i = new e.Point(k.right, o)))
            : ((g = new e.Point(l.left, p)),
              (h = new e.Point(k.right + 10, o)),
              (i = new e.Point(k.left, o))),
            (j = (g.x + h.x) / 2),
            m.push("M", g),
            m.push("C", j, g.y, j, h.y, h),
            m.push("L", i),
            c.setMarker(null),
            c.setPathData(m);
        });
          ...
          Object.defineProperty(e.Box.prototype, "visualization", {
            ...
            f.registerInitHook(function () {
              this.on("paperrender", function () {
                (g = new e.Rect()),
                  g.fill("rgba(200, 200, 200, .5)"),
                  g.stroke("orange"),
                  this.getRenderContainer().addShape(g);
              });
            });
        }
      },
      ...
      value: function (a, c, d) {
        ...
        e.registerInitHook(function () {
          ...
          (e.prototype.disableAnimation = function () {
            for (var a in f)
              f.hasOwnProperty(a) &&
                ((g[a] = this.getOption(a)), this.setOption(a, 0));
          });
      },
    }),
    (b[9] = {
            ...
            execCommand: function (a) {
              ...
              return (
                ...
                !(!b || !~this.queryCommandState(a)) &&
                  (this._hasEnterExecCommand
                    ? ((d = b.execute.apply(b, [h].concat(f))),
                      this._hasEnterExecCommand || this._interactChange())
                    : ((this._hasEnterExecCommand = !0),
                      (c = this._fire(new g("beforeExecCommand", e, !0))),
                      c ||
                        (this._fire(new g("preExecCommand", e, !1)),
                        (d = b.execute.apply(b, [h].concat(f))),
                        this._fire(new g("execCommand", e, !1)),
                        b.isContentChanged() &&
                          this._firePharse(new g("contentchange")),
    ...
    (b[10] = {
      value: function (a, c, d) {
        function e(a) {
          switch (a.version || (a.root ? "1.4.0" : "1.1.3")) {
            case "1.1.3":
              h(a);
            case "1.2.0":
            case "1.2.1":
        ...
        function g(a) {
          f(a, function (a) {
            var b = a.data;
            delete b.layout_bottom_offset,
              delete b.layout_default_offset,
              delete b.layout_filetree_offset;
          });
        }
        function h(a) {
          var b = a.data.currentstyle;
          delete a.data.currentstyle,
            "bottom" == b
              ? ((a.template = "structure"), (a.theme = "snow"))
              : "default" == b &&
                ((a.template = "default"), (a.theme = "classic")),
            f(a, function (a) {
              var b = a.data;
              "PriorityIcon" in b &&
                ((b.priority = b.PriorityIcon), delete b.PriorityIcon),
                "ProgressIcon" in b &&
                  ((b.progress = 1 + ((b.ProgressIcon - 1) << 1)),
                  delete b.ProgressIcon),
                delete b.point,
                delete b.layout;
            });
        }
        function i(a) {
          (a.root = { data: a.data, children: a.children }),
            delete a.data,
            delete a.children;
        }
        b.r(33);
          ...
          f.extendClass(i, {
            ...
            createConnect: function (a) {
              if (!a.isRoot()) {
                var b = new f.Path();
                (a._connection = b),
                  this._connectContainer.addShape(b),
                  this.updateConnect(a);
              }
            },
            removeConnect: function (a) {
              var b = this;
              a.traverse(function (a) {
                b._connectContainer.removeShape(a._connection),
                  (a._connection = null);
              });
            },
            updateConnect: function (a) {
              ...
              if (c && b) {
                ...
                b.stroke(e, f),
                  d(a, c, b, f, e),
                  f % 2 == 0 ? b.setTranslate(0.5, 0.5) : b.setTranslate(0, 0);
              }
            },
          }),
          h.register("Connect", {
            init: function () {
              (this._connectContainer = new f.Group().setId(
                g.uuid("minder_connect_group")
              )),
    ...
    (b[12] = {
      value: function (a, c, d) {
        function e(a, b) {
          l[a] = b;
          for (var c in l)
            l.hasOwnProperty(c) && ((l[c] = l[c]), (l[c].name = c));
        }
        function f(a) {
        ...
        var g = b.r(17),
          ...
          k = b.r(25),
          l = {};
        (c.registerProtocol = e),
          (c.getRegisterProtocol = f),
          g.extendClass(h, {
            setup: function (a) {
              if (
            ...
            exportNode: function (a) {
              ...
              for (var d = 0; d < c.length; d++)
                b.children.push(this.exportNode(c[d]));
              return b;
            },
            ...
            importJson: function (a) {
              if (a) {
                for (
                  this._fire(new i("preimport", null, !1));
                  this._root.getChildren().length;

                )
                  this.removeNode(this._root.getChildren()[0]);
                return (
                  (a = j(a)),
                  this.importNode(this._root, a.root),
                  this.setTemplate(a.template || "default"),
                  this.setTheme(a.theme || null),
                  this.refresh(),
                  this.fire("import"),
              ...
              return (
                ...
                !a || ((d = l[a]) && d.encode)
                  ? (this._fire(
                    ...
                    k.resolve(d.encode(c, this, b)))
                  : k.reject(new Error("Not supported protocol:" + a))
              );
            },
            importData: function (a, b, c) {
              var d,
                e = this;
              if (a && (!(d = l[a]) || !d.decode))
                return k.reject(new Error("Not supported protocol:" + a));
              var f = { local: b, protocolName: a, protocol: d };
              return (
                this._fire(new i("beforeimport", f)),
                k.resolve(d.decode(b, this, c)).then(function (a) {
            ...
            decodeData: function (a, b, c) {
              ...
              if (a && (!(d = l[a]) || !d.decode))
                return k.reject(new Error("Not supported protocol:" + a));
              var e = { local: b, protocolName: a, protocol: d };
              return (
                this._fire(new i("beforeimport", e)),
                k.resolve(d.decode(b, this, c))
              );
            },
          });
      },
        ...
        var e = b.r(17),
          ...
          g = e.createClass("MindEvent", {
            constructor: function (a, b, c) {
              (b = b || {}),
                b.getType && "ShapeEvent" == b.getType()
                  ? ((this.kityEvent = b), (this.originEvent = b.originEvent))
                  : b.target && b.preventDefault
                  ? (this.originEvent = b)
                  : e.Utils.extend(this, b),
                (this.type = a),
                (this._canstop = c || !1);
            },
            getPosition: function (a) {
              if (this.kityEvent)
                return a && "minder" != a
                  ? this.kityEvent.getPosition.call(this.kityEvent, a)
                  : this.kityEvent.getPosition(
                      this.minder.getRenderContainer()
                    );
            },
            ...
            isRightMB: function () {
              ...
              return (
                !!this.originEvent &&
                ("which" in this.originEvent
                  ? (a = 3 == this.originEvent.which)
                  : "button" in this.originEvent &&
                    (a = 2 == this.originEvent.button),
                a)
              );
            },
            getKeyCode: function () {
          ...
          e.extendClass(f, {
            ...
            _firePharse: function (a) {
              ...
              "DOMMouseScroll" == a.type &&
                ((a.type = "mousewheel"),
                (a.wheelDelta = a.originEvent.wheelDelta =
                  -10 * a.originEvent.detail),
                (a.wheelDeltaX = a.originEvent.mozMovementX),
                (a.wheelDeltaY = a.originEvent.mozMovementY)),
                (b = new g("before" + a.type, a, !0)),
                this._fire(b) ||
                  ((c = new g("pre" + a.type, a, !0)),
                  (d = new g(a.type, a, !0)),
                  (this._fire(c) || this._fire(d)) &&
                    this._fire(new g("after" + a.type, a, !1)));
            },
            _interactChange: function (a) {
              var b = this;
              b._interactScheduled ||
                (setTimeout(function () {
                  b._fire(new g("interactchange")), (b._interactScheduled = !1);
                }, 100),
                (b._interactScheduled = !0));
            },
            _listen: function (a, b) {
              (this._eventCallbacks[a] || (this._eventCallbacks[a] = [])).push(
                b
              );
            },
            _fire: function (a) {
              ...
              if (
                (b &&
                  (c = c.concat(
                    this._eventCallbacks[b + "." + a.type.toLowerCase()] || []
                  )),
                0 !== c.length)
              ) {
                for (
                  var d = (this.getStatus(), 0);
                  d < c.length &&
                  (c[d].call(this, a), !a.shouldStopPropagationImmediately());
                  d++
                );
    ...
    (b[15] = {
      value: function (a, b, c) {
        var d = {
          ...
          "/": 191,
          ".": 190,
          controlKeys: { 16: 1, 17: 1, 18: 1, 20: 1, 91: 1, 224: 1 },
          notContentChange: {
            13: 1,
            9: 1,
            33: 1,
    ...
    (b[16] = {
      value: function (a, c, d) {
        ...
        g.registerInitHook(function (a) {
          this.setDefaultOptions({ enableKeyReceiver: !0 }),
            this.getOption("enableKeyReceiver") &&
              this.on("paperrender", function () {
          ...
          f.extendClass(g, {
            _initKeyReceiver: function () {
              if (!this._keyReceiver) {
                ...
                this._renderTarget.appendChild(a);
                var b = this;
                e(
                  a,
                  ...
                  function (c) {
                    ...
                    b._firePharse(c), c.preventDefault();
                  }
                ),
          ...
          l = g.createClass("Layout", {
            ...
            stack: function (a, b, c) {
              ...
              return (
                (c =
                  ...
                  function (a, b, c) {
                    return (
                      a.getStyle({ x: "margin-right", y: "margin-bottom" }[c]) +
                      b.getStyle({ x: "margin-left", y: "margin-top" }[c])
                    );
                  }),
                a.forEach(function (a, f, g) {
                  var h = d.getTreeBox([a]),
                    i = { x: h.width, y: h.height }[b],
                    j = { x: h.left, y: h.top }[b],
                    k = a.getLayoutTransform();
                  "x" == b ? k.translate(e - j, 0) : k.translate(0, e - j),
                    (e += i),
                    g[f + 1] && (e += c(a, g[f + 1], b));
                }),
                e
            ...
            getBranchBox: function (a) {
              ...
              for (b = 0; b < a.length; b++)
                (c = a[b]),
                  (d = c.getLayoutTransform()),
                  (e = c.getContentBox()),
                  (f = f.merge(d.transformBox(e)));
              return f;
            },
            getTreeBox: function (a) {
              var b,
                ...
                e,
                f = new g.Box();
              for (a instanceof Array || (a = [a]), b = 0; b < a.length; b++)
                (c = a[b]),
                  (d = c.getLayoutTransform()),
                  (e = c.getContentBox()),
                  c.isExpanded() &&
                    c.children.length &&
                    (e = e.merge(this.getTreeBox(c.children))),
                  (f = f.merge(d.transformBox(e)));
              return f;
            },
        ...
        (l.register = e),
          ...
          g.extendClass(j, {
            ...
            getGlobalLayoutTransformPreview: function () {
              var a = this.parent
                  ? this.parent.getLayoutTransform()
                  : new g.Matrix(),
            ...
            getLayoutPointPreview: function () {
              return this.getGlobalLayoutTransformPreview().transformPoint(
                new g.Point()
              );
            },
            getGlobalLayoutTransform: function () {
              return this._globalLayoutTransform
                ? this._globalLayoutTransform
                : this.parent
                ? this.parent.getGlobalLayoutTransform()
                : new g.Matrix();
            },
            ...
            setGlobalLayoutTransform: function (a) {
              return (
                this.getRenderContainer().setMatrix(
                  (this._globalLayoutTransform = a)
                ),
                this
              );
            },
            ...
            getLayoutVertexIn: function () {
              return this.getGlobalLayoutTransform().transformPoint(
                this.getVertexIn()
              );
            },
            ...
            getLayoutBox: function () {
              return this.getGlobalLayoutTransform().transformBox(
                this.getContentBox()
              );
            },
          ...
          g.extendClass(i, {
            layout: function () {
              function a(b, c) {
                b.isExpanded(),
                  ...
                  b.getLayoutInstance().doLayout(b, b.getChildren(), c);
              }
              ...
              var c = this;
              return (
                this.applyLayoutResult(this.getRoot(), b, function () {
                  setTimeout(function () {
            ...
            applyLayoutResult: function (a, b, c) {
              ...
              function e(a, b) {
                a.setGlobalLayoutTransform(b),
                  h.fire("layoutapply", { node: a, matrix: b });
              }
              function f(a, c) {
                var i = a.getLayoutTransform().merge(c.clone()),
                  ...
                  k = a.getLayoutOffset();
                i.translate(k.x, k.y),
                  (i.m.e = Math.round(i.m.e)),
                  (i.m.f = Math.round(i.m.f)),
                  a._layoutTimeline &&
                    (a._layoutTimeline.stop(), (a._layoutTimeline = null)),
                  b
                    ? (a._layoutTimeline = new g.Animator(j, i, e)
                        .start(a, b, "ease")
                        .on("finish", function () {
                          setTimeout(function () {
                            e(a, i),
                              h.fire("layoutfinish", { node: a, matrix: i }),
                              d();
                          }, 150);
                        }))
                    : (e(a, i),
              ...
              return (
                ...
                f(
                  a,
                  a.parent
                    ? a.parent.getGlobalLayoutTransform()
                    : new g.Matrix()
                ),
                this
              );
        ...
        var e = b.r(17),
          ...
          h = e.createClass("Minder", {
            constructor: function (a) {
              ...
              for (var b, c = g.slice(); c.length; )
                "function" == typeof (b = c.shift()) &&
                  b.call(this, this._options);
              this.fire("finishInitHook");
            },
          });
        (h.version = "1.4.43"),
          (h.registerInitHook = function (a) {
            g.push(a);
          }),
          (d.exports = h);
      },
            ...
            _initModules: function () {
              ...
              for (c = 0; c < b.length; c++)
                if (
                  ((d = b[c]),
                  a[d] &&
                    ((g = "function" == typeof a[d] ? a[d].call(l) : a[d]),
                    (this._modules[d] = g),
                    g))
                ) {
                  g.defaultOptions && l.setDefaultOptions(g.defaultOptions),
                    g.init && g.init.call(l, this._options),
                    (i = g.commands);
                  for (d in i) this._commands[d.toLowerCase()] = new i[d]();
                  if ((j = g.events)) for (e in j) l.on(e, j[e]);
                  if ((k = g.renderers))
                    for (e in k)
                      (this._rendererClasses[e] =
                        this._rendererClasses[e] || []),
                        f.isArray(k[e])
                          ? (this._rendererClasses[e] = this._rendererClasses[
                              e
                            ].concat(k[e]))
                          : this._rendererClasses[e].push(k[e]);
                  g.commandShortcutKeys &&
                    this.addCommandShortcutKeys(g.commandShortcutKeys);
                }
            },
            _garbage: function () {
          ...
          h = e.createClass("MinderNode", {
            constructor: function (a) {
              (this.parent = null),
                (this.root = this),
                (this.children = []),
                (this.data = { id: f.guid(), created: +new Date() }),
                this.initContainers(),
                f.isString(a)
                  ? this.setText(a)
                  : f.isObject(a) && f.extend(this.data, a);
            },
            initContainers: function () {
              (this.rc = new e.Group().setId(f.uuid("minder_node"))),
            ...
            getType: function (a) {
              return (
                (this.type = ["root", "main", "sub"][
                  Math.min(this.getLevel(), 2)
                ]),
                this.type
              );
            },
            ...
            removeChild: function (a) {
              var b,
                c = a;
              a instanceof h && (c = this.children.indexOf(a)),
                c >= 0 &&
                  ((b = this.children.splice(c, 1)[0]),
                  (b.parent = null),
                  (b.root = b));
            },
            ...
            getCommonAncestor: function (a) {
              return h.getCommonAncestor(this, a);
            },
            contains: function (a) {
        ...
        (h.getCommonAncestor = function (a, b) {
          ...
          e.extendClass(g, {
            ...
            getAllNode: function () {
              var a = [];
              return (
                this.getRoot().traverse(function (b) {
                  a.push(b);
                }),
                a
              );
            ...
            createNode: function (a, b, c) {
              var d = new h(a);
              return (
                this.fire("nodecreate", { node: d, parent: b, index: c }),
                this.appendNode(d, b, c),
                d
              );
            },
            ...
            attachNode: function (a) {
              ...
              a.traverse(function (a) {
                ...
                b.addShape(a.getRenderContainer()),
                this.fire("nodeattach", { node: a });
            },
          ...
          e.extendClass(g, {
            ...
            getOption: function (a) {
              return a
                ...
                : f.extend({}, this._defaultOptions, this._options);
            },
    ...
    (b[23] = {
      value: function (a, c, d) {
        ...
        g.registerInitHook(function () {
          ...
          e.extendClass(g, {
            _initPaper: function () {
              (this._paper = new e.Paper()),
                (this._paper._minder = this),
                (this._paper.getNode().ondragstart = function (a) {
                  a.preventDefault();
                }),
                this._paper.shapeNode.setAttribute(
                  "transform",
                  "translate(0.5, 0.5)"
                ),
            ...
            _addRenderContainer: function () {
              (this._rc = new e.Group().setId(f.uuid("minder"))),
            ...
            renderTo: function (a) {
              if (
                ...
                a.classList.add("km-view"),
                  this._paper.renderTo((this._renderTarget = a)),
                  this._bindEvents(),
    ...
    (b[24] = {
      value: function (a, c, d) {
        function e(a, b, c, d) {
          return (
            (c = a.createNode(b.data, c, d)),
            b.children.forEach(function (b, d) {
              e(a, b, c, d);
            }),
            c
          );
        ...
        function f(a, b) {
          ...
          if ("root" == f) {
            ...
            d = a.getRoot();
            for (var i, j; (i = c.shift()); )
              "children" != i &&
                (void 0 !== j && (d = d.getChild(j)), (j = +i));
            (b.index = j), (b.node = d);
          }
          switch ((b.express = [f, b.op].join("."))) {
            case "theme.replace":
              a.useTheme(b.value);
              break;
            ...
            case "data.remove":
              var k,
                l = b.node.data;
              for (c = b.dataPath.slice(); l && c.length > 1; )
                (k = c.shift()),
                  k in l ? (l = l[k]) : "remove" != b.op && (l = l[k] = {});
              l && ((k = c.shift()), (l[k] = b.value)),
                "expandState" == k ? d.renderTree() : d.render(),
                a.layout();
          }
          a.fire("patch", { patch: b });
        }
        var g = b.r(17),
          h = b.r(19);
        g.extendClass(h, {
    ...
    (b[25] = {
      value: function (a, b, c) {
        ...
        (g.prototype = {
          ...
          then: function (a, b) {
            var c = this,
              d = new g();
            return (
              c.onFulfilled.push(k(a, d, "fulfill")),
              c.onRejected.push(k(b, d, "reject")),
              i(c),
              d
            );
          },
        ...
        var h = function (a, b, c, e) {
          ...
          i = function (a) {
            a.state === e
              ? j(a, "onFulfilled", a.fulfillValue)
              : a.state === f && j(a, "onRejected", a.rejectReason);
          },
          j = function (a, b, c) {
            if (0 !== a[b].length) {
              var d = a[b];
          ...
          l = function (a, b) {
            ...
            var c;
            if (("object" == typeof b && null !== b) || "function" == typeof b)
              try {
                c = b.then;
              } catch (b) {
      ...
      value: function (a, c, d) {
        ...
        f.registerInitHook(function (a) {
          ...
          e.extendClass(f, {
            disable: function () {
              var a = this;
              (a.bkqueryCommandState = a.queryCommandState),
                (a.bkqueryCommandValue = a.queryCommandValue),
                (a.queryCommandState = function (b) {
                  var c = this._getCommand(b);
                  return c && c.enableReadOnly
                    ? a.bkqueryCommandState.apply(a, arguments)
                    : -1;
                }),
                (a.queryCommandValue = function (b) {
                  var c = this._getCommand(b);
                  return c && c.enableReadOnly
                    ? a.bkqueryCommandValue.apply(a, arguments)
                    : null;
                }),
            ...
            enable: function () {
              var a = this;
              a.bkqueryCommandState &&
                ((a.queryCommandState = a.bkqueryCommandState),
                delete a.bkqueryCommandState),
                a.bkqueryCommandValue &&
                  ((a.queryCommandValue = a.bkqueryCommandValue),
                  delete a.bkqueryCommandValue),
    ...
    (b[27] = {
      value: function (a, c, d) {
            ...
            renderNodeBatch: function (b) {
              ...
              if (b.length) {
                for (d = 0; d < b.length; d++)
                  (g = b[d]),
                    g._renderers || a(g, h),
                    (g._contentBox = new f.Box()),
                    this.fire("beforerender", { node: g });
                for (j = b[0]._renderers.length, c = 0; c < j; c++) {
                  for (d = 0; d < b.length; d++)
                    "function" == typeof i[d] && (i[d] = i[d]()),
                      i[d] instanceof f.Box || (i[d] = new f.Box(i[d]));
                  for (d = 0; d < b.length; d++)
                    (g = b[d]),
                      (e = g._renderers[c]),
                      i[d] &&
                        ((g._contentBox = g._contentBox.merge(i[d])),
                        (e.contentBox = i[d])),
                      e.shouldRender(g)
                        ? (e.getRenderShape() ||
                            (e.setRenderShape(e.create(g)),
                            e.bringToBack
                              ? g
                                  .getRenderContainer()
                                  .prependShape(e.getRenderShape())
                              : g
                                  .getRenderContainer()
                                  .appendShape(e.getRenderShape())),
                          e.getRenderShape().setVisible(!0),
                          (i[d] = e.update(
                            e.getRenderShape(),
                            g,
                            g._contentBox
                        ...
                        : e.getRenderShape() &&
                          (e.getRenderShape().setVisible(!1), (i[d] = null));
                }
                for (d = 0; d < b.length; d++)
                  this.fire("noderender", { node: b[d] });
              }
            },
            renderNode: function (b) {
              var c,
                d = this._rendererClasses;
              b._renderers || a(b, d),
                this.fire("beforerender", { node: b }),
                (b._contentBox = new f.Box()),
                b._renderers.forEach(function (a) {
                  a.shouldRender(b)
                    ? (a.getRenderShape() ||
                        (a.setRenderShape(a.create(b)),
                        a.bringToBack
                          ? b
                              .getRenderContainer()
                              .prependShape(a.getRenderShape())
                          : b
                              .getRenderContainer()
                              .appendShape(a.getRenderShape())),
                      a.getRenderShape().setVisible(!0),
                      (c = a.update(a.getRenderShape(), b, b._contentBox)),
                      "function" == typeof c && (c = c()),
                      c &&
                        ((b._contentBox = b._contentBox.merge(c)),
                        (a.contentBox = c)))
                    : a.getRenderShape() && a.getRenderShape().setVisible(!1);
                }),
                this.fire("noderender", { node: b });
            },
          };
        }
        var f = b.r(17),
        ...
        f.extendClass(g, e()),
          f.extendClass(h, {
            render: function () {
              if (this.attached) return this.getMinder().renderNode(this), this;
            },
            renderTree: function () {
              if (this.attached) {
                var a = [];
                return (
                  ...
                  this.getMinder().renderNodeBatch(a),
                  this
                );
              }
            },
          ...
          e.extendClass(g, {
            ...
            renderChangedSelection: function (a) {
              ...
              for (
                b.forEach(function (b) {
                  ...
                  c.length &&
                    (this._interactChange(), this.fire("selectionchange"));
                c.length;
            ...
            removeSelectedNodes: function (a) {
              ...
              return (
                ...
                a.forEach(function (a) {
                  var c;
                  -1 !== (c = b._selectedNodes.indexOf(a)) &&
                    b._selectedNodes.splice(c, 1);
                }),
                this.renderChangedSelection(c),
                this
              );
            },
            select: function (a, b) {
              ...
              return (
                (a = f.isArray(a) ? a : [a]),
                a.forEach(function (a) {
                  -1 === d._selectedNodes.indexOf(a) &&
                    d._selectedNodes.unshift(a);
                }),
                this.renderChangedSelection(c),
                this
              );
            ...
            toggleSelect: function (a) {
              return (
                f.isArray(a)
                  ? a.forEach(this.toggleSelect.bind(this))
                  : a.isSelected()
                  ? this.removeSelectedNodes(a)
                  : this.select(a),
                this
              );
            },
            ...
            getSelectedAncestors: function (a) {
              ...
              var c,
                d = this.getSelectedNodes().slice(0),
                e = [],
        ...
        f.extendClass(j, {
          ...
          f.extendClass(i, {
            ...
            _bindShortcutKeys: function () {
              var a = (this._shortcutKeys = {});
              this.on("keydown", function (b) {
                for (var c in a)
                  if (a.hasOwnProperty(c) && b.isShortcutKey(c)) {
                    var d = a[c];
                    if (
                      d.__statusCondition &&
                      d.__statusCondition != this.getStatus()
                    )
                      return;
                    d(), b.preventDefault();
                  }
            ...
            addShortcut: function (a, b) {
              ...
              a.split(/\|\s*/).forEach(function (a) {
                var d,
                  e = a.split("::");
                e.length > 1 &&
                  ((a = e[1]), (d = e[0]), (b.__statusCondition = d)),
                  (c[a] = b);
              });
            },
            addCommandShortcutKeys: function (a, b) {
              var c =
                  this._commandShortcutKeys || (this._commandShortcutKeys = {}),
                d = {};
              b ? (d[a] = b) : (d = a);
              var e = this;
              g.each(d, function (a, b) {
                (c[b] = a),
                  e.addShortcut(a, function () {
        ...
        f.registerInitHook(function () {
          ...
          e.extendClass(f, {
            ...
            setStatus: function (a, b) {
              return "readonly" != this._status || b
                ? (a != this._status &&
          ...
          f.extendClass(
            ...
            (function () {
              ...
              return {
                ...
                getTheme: function (b) {
                  return (this.getTemplateSupport("getTheme") || a).call(
                    this,
                    b
                  );
                },
          ...
          f.extendClass(
            ...
            (function () {
              ...
              return {
                getLayout: function () {
                  return (
                    this.getMinder().getTemplateSupport("getLayout") || a
                  ).call(this, this);
                },
                getConnect: function () {
                  return (
                    this.getMinder().getTemplateSupport("getConnect") || b
                  ).call(this, this);
                },
              };
            })()
        ...
        (c.register = e),
          ...
          f.extendClass(h, {
            ...
            setTheme: function (a) {
              ...
              return (
                c &&
                  (c.classList.remove("km-theme-" + b),
                  a && c.classList.add("km-theme-" + a),
                  (c.style.background = this.getStyle("background"))),
                this.fire("themechange", { theme: a }),
                this
              );
            },
            getTheme: function (a) {
              return (
                this._theme || this.getOption("defaultTheme") || "fresh-blue"
              );
            },
            ...
            getStyle: function (a, b) {
              var c,
                ...
                e,
                f,
                h = this.getThemeItems(b);
              if (a in h) return h[a];
              if (((c = a.split("-")), c.length < 2)) return null;
              if (((d = c.pop()), (a = c.join("-")) in h)) {
          ...
          j.register("Theme", {
            defaultOptions: { defaultTheme: "fresh-blue" },
            commands: {
    ...
    (b[33] = {
      value: function (a, c) {
        var d = b.r(17),
          e = {};
        (c.extend = d.Utils.extend.bind(d.Utils)),
          (c.each = d.Utils.each.bind(d.Utils)),
          (c.uuid = function (a) {
          ...
          g.register(
            ...
            f.createClass({
              ...
              doLayout: function (b, g) {
                ...
                if (
                  ("x" == c
                    ? (b.setVertexOut(new f.Point(h[a], h.cy)),
                      b.setLayoutVectorOut(new f.Vector(d, 0)))
                    : (b.setVertexOut(new f.Point(h.cx, h[a])),
                      b.setLayoutVectorOut(new f.Vector(0, d))),
                  !g.length)
                )
                  return !1;
                g.forEach(function (b) {
                  var g = b.getContentBox();
                  b.setLayoutTransform(new f.Matrix()),
                    "x" == c
                      ? (b.setVertexIn(new f.Point(g[e[a]], g.cy)),
                        b.setLayoutVectorIn(new f.Vector(d, 0)))
                      : (b.setVertexIn(new f.Point(g.cx, g[e[a]])),
                        b.setLayoutVectorIn(new f.Vector(0, d)));
                }),
                  this.align(g, e[a]),
                  this.stack(g, e[c]);
                ...
                "x" == c
                  ? ((j = h[a]),
                    (j += d * b.getStyle("margin-" + a)),
                    (j += d * g[0].getStyle("margin-" + e[a])),
                    (k = h.bottom),
                    (k -= h.height / 2),
                    (k -= i.height / 2),
                    (k -= i.y))
                  : ((j = h.right),
                    ...
                    (j -= i.x),
                    (k = h[a]),
                    (k += d * b.getStyle("margin-" + a)),
                    (k += d * g[0].getStyle("margin-" + e[a]))),
                  this.move(g, j, k);
              },
              getOrderHint: b,
            })
          ...
          g.register(
            ...
            f.createClass({
              ...
              doLayout: function (b, c, d) {
                ...
                if (
                  (b.setVertexOut(
                    new f.Point(e.left + g, a > 0 ? e.bottom : e.top)
                  ),
                  b.setLayoutVectorOut(new f.Vector(0, a)),
                  c.length)
                ) {
                  c.forEach(function (a) {
                    var b = a.getContentBox();
                    a.setLayoutTransform(new f.Matrix()),
                      a.setVertexIn(new f.Point(b.left, b.cy)),
                      a.setLayoutVectorIn(new f.Vector(1, 0));
                  }),
                    this.align(c, "left"),
                    this.stack(c, "y");
                  var h = 0;
                  ...
                  a > 0
                    ? ((i += e.bottom),
                      (i += b.getStyle("margin-bottom")),
                      (i += c[0].getStyle("margin-top")))
                    : ((i -= this.getTreeBox(c).bottom),
                      (i += e.top),
                      (i -= b.getStyle("margin-top")),
                      (i -= c[0].getStyle("margin-bottom"))),
                    this.move(c, h, i);
                }
              },
              getOrderHint: function (a) {
    ...
    (b[38] = {
      value: function (a, c, d) {
        ...
        f.register(
          "fish-bone-master",
          e.createClass("FishBoneMasterLayout", {
            base: f,
            doLayout: function (a, b, c) {
              var d = [],
                ...
                h = a.getContentBox();
              if (
                (a.setVertexOut(new e.Point(h.right, h.cy)),
                a.setLayoutVectorOut(new e.Vector(1, 0)),
                g)
              ) {
                ...
                b.forEach(function (a, b) {
                  ...
                  b % 2
                    ? (f.push(a),
                      a.setVertexIn(new e.Point(c.left, c.top)),
                      a.setLayoutVectorIn(new e.Vector(1, 1)))
                    : (d.push(a),
                      a.setVertexIn(new e.Point(c.left, c.bottom)),
                      a.setLayoutVectorIn(new e.Vector(1, -1)));
                }),
                  this.stack(d, "x"),
                  this.stack(f, "x"),
    ...
    (b[39] = {
      value: function (a, c, d) {
        ...
        f.register(
          "fish-bone-slave",
          e.createClass("FishBoneSlaveLayout", {
            base: f,
            doLayout: function (a, b, c) {
              var d = this,
                f = Math.abs,
              ...
              if (l) {
                ...
                b.forEach(function (a, b) {
                  a.setLayoutTransform(new e.Matrix()),
                    a.setLayoutVectorIn(new e.Vector(1, 0)),
                    a.setVertexIn(new e.Point(m.left, m.cy));
                }),
                  this.stack(b, "y"),
                  this.align(b, "left");
                var n = 0,
                  o = 0;
                (n += k.x),
                  a.getLayoutVectorOut().y < 0
                    ? ((o -= this.getTreeBox(b).bottom),
                      (o += a.getContentBox().top),
                      (o -= a.getStyle("margin-top")),
                      (o -= l.getStyle("margin-bottom")))
                    : ((o += a.getContentBox().bottom),
                      (o += a.getStyle("margin-bottom")),
                      (o += l.getStyle("margin-top"))),
                  this.move(b, n, o),
                  2 == c &&
        ...
        f.register(
          ...
          e.createClass({
            ...
            doLayout: function (a, b) {
              ...
              a.setVertexOut(new e.Point(j.cx, j.cy)),
                a.setLayoutVectorOut(new e.Vector(0, 0));
            },
            getOrderHint: function (a) {
              var b = [],
                c = a.getLayoutBox(),
            ...
            doLayout: function (a, b) {
              if (0 != b.length) {
                ...
                b.forEach(function (a, b) {
                  a.setLayoutTransform(new e.Matrix()),
                    (f = g.getTreeBox(a)),
                    (j = Math.max(Math.max(f.width, f.height), j));
                }),
                  (j = j / 1.5 / Math.PI),
                  b.forEach(function (a, b) {
                    (c = j * (Math.cos(i) + Math.sin(i) * i)),
                      (d = j * (Math.sin(i) - Math.cos(i) * i)),
                      (i += 0.9 - 0.02 * b),
                      a.setLayoutVectorIn(new e.Vector(1, 0)),
                      a.setVertexIn(new e.Point(h.cx, h.cy)),
                      a.setLayoutTransform(new e.Matrix()),
                      g.move([a], c, d);
                  });
              }
    ...
    (b[42] = {
      value: function (a, c, d) {
        ...
        g.extendClass(h, {
          arrange: function (a) {
            ...
            if (b) {
              var c = b.children;
              if (!(a < 0 || a >= c.length))
                return c.splice(this.getIndex(), 1), c.splice(a, 0, this), this;
            }
          },
        });
        var k = g.createClass("ArrangeUpCommand", {
          ...
          m = g.createClass("ArrangeCommand", {
            ...
            execute: function (a, b) {
              ...
              if (c.length) {
                if (h.getCommonAncestor(c) == c[0].parent) {
                  var d = c.map(function (a) {
                      return { index: a.getIndex(), node: a };
                    }),
                    e =
                      Math.min.apply(
                        Math,
                  ...
                  d.sort(function (a, b) {
                    return e ? b.index - a.index : a.index - b.index;
                  }),
        ...
        j.register("ArrangeModule", {
          commands: { arrangeup: k, arrangedown: l, arrange: m },
          contextmenu: [
            { command: "arrangeup" },
            { command: "arrangedown" },
            { divider: !0 },
    ...
    (b[43] = {
      value: function (a, c, d) {
        ...
        g.register("basestylemodule", function () {
          ...
          var b = this;
          return (
            h.registerStyleHook(function (b, c) {
              var d = a(b, "font-weight"),
                e = a(b, "font-style");
              [d, e].join("/");
              c.eachItem(function (a, b) {
                b.setFont({ weight: d, style: e });
              });
            }),
            {
              commands: {
                bold: e.createClass("boldCommand", {
                  ...
                  queryState: function () {
                    ...
                    return 0 === a.length
                      ? -1
                      : (a.forEach(function (a) {
                          if (a && a.getData("font-weight")) return (c = 1), !1;
                        }),
                        c);
                  },
                }),
                italic: e.createClass("italicCommand", {
                  ...
                  queryState: function () {
                    ...
                    return 0 === a.length
                      ? -1
                      : (a.forEach(function (a) {
                          if (a && a.getData("font-style")) return (c = 1), !1;
                        }),
                        c);
                  },
                }),
          ...
          var c = this,
            ...
            j = e.createClass("CutCommand", {
              ...
              execute: function (a) {
                ...
                0 !== c.length &&
                  (b(c),
                  a.select(f.getCommonAncestor(c), !0),
                  c.slice().forEach(function (b) {
                    a.removeNode(b);
                  }),
                  a.layout(300));
              },
      ...
      value: function (a, c, d) {
        var e = b.r(17),
          ...
          i = e.createClass("MoveToParentCommand", {
            ...
            execute: function (a, b, c) {
              for (var d, e = 0; e < b.length; e++)
                (d = b[e]),
                  d.parent &&
                    (d.parent.removeChild(d), c.appendChild(d), d.render());
          ...
          j = e.createClass("DropHinter", {
            ...
            render: function (a) {
              this.setVisible(!!a),
                a &&
                  (this.rect
                    .setBox(a.getLayoutBox())
                    .setRadius(a.getStyle("radius") || 0)
                    .stroke(
                      a.getStyle("drop-hint-color") || "yellow",
                      a.getStyle("drop-hint-width") || 2
                    ),
                  this.bringTop());
            },
          }),
          k = e.createClass("OrderHinter", {
            ...
            constructor: function () {
              this.callBase(),
                (this.area = new e.Rect()),
                (this.path = new e.Path()),
                this.addShapes([this.area, this.path]);
            },
            render: function (a) {
              this.setVisible(!!a),
                a &&
                  (this.area.setBox(a.area),
                  this.area.fill(
                    a.node.getStyle("order-hint-area-color") ||
                      "rgba(0, 255, 0, .5)"
                  ),
                  this.path.setPathData(a.path),
                  this.path.stroke(
                    a.node.getStyle("order-hint-path-color") || "#0f0",
                    a.node.getStyle("order-hint-path-width") || 1
                  ));
            },
          }),
          l = e.createClass("TreeDragger", {
            constructor: function (a) {
              (this._minder = a),
                (this._dropHinter = new j()),
                (this._orderHinter = new k()),
                a
                  .getRenderContainer()
            ...
            dragMove: function (a) {
              if (this._startPosition) {
                ...
                for (var d = 0; d < this._dragSources.length; d++)
                  this._dragSources[d].setLayoutOffset(
                    this._dragSources[d].getLayoutOffset().offset(b)
                  ),
                    c.applyLayoutResult(this._dragSources[d]);
                this._dropTest()
            ...
            dragEnd: function () {
              if (
                ...
                if ((this._fadeDragSources(1), this._dropSucceedTarget))
                  this._dragSources.forEach(function (a) {
                  ...
                  b < e && "down" == a.type && b++,
                    b > d && "up" == a.type && b--,
                    a.node.setLayoutOffset(null),
                    this._minder.execCommand("arrange", b),
            ...
            _fadeDragSources: function (a) {
              ...
              this._dragSources.forEach(function (c) {
                c.getRenderContainer().setOpacity(a, 200),
                  c.traverse(function (c) {
                    a < 1 ? b.detachNode(c) : b.attachNode(c);
                  }, !0);
              });
            },
            _calcDropTargets: function () {
              function a(b, c) {
                ...
                return (
                  ...
                  c.getChildren().forEach(function (c) {
                    for (d = 0; d < b.length; d++) if (b[d] == c) return;
                    e = e.concat(a(b, c));
                  }),
                  e
                );
              ...
              (this._dropTargets = a(
                ...
                (this._dropTargetBoxes = this._dropTargets.map(function (a) {
            ...
            _boxTest: function (a, b, c) {
              var d,
                ...
                g,
                h,
                i = this._dragSources.map(function (a) {
                  return a.getLayoutBox();
                });
              for (
                c =
                ...
                (this._dropSucceedTarget = this._boxTest(
                  ...
                  function (a, b, c) {
                    ...
                    return (
                      !!a &&
                      !!d(a) &&
                      (d(a) > 0.5 * Math.min(d(b), d(c)) ||
                        a.width + 1 >= Math.min(b.width, c.width) ||
                        a.height + 1 >= Math.min(b.height, c.height))
                    );
                  }
                )),
            ...
            _orderTest: function () {
              return (
                (this._orderSucceedHint = this._boxTest(
                  this._orderHints,
                  function (a) {
                    return a.area;
                  }
          ...
          return {
            ...
            events: {
              "normal.mousedown inputready.mousedown": function (b) {
                b.originEvent.button ||
                  (b.getTargetNode() &&
                    b.getTargetNode() != this.getRoot() &&
                    a.dragStart(b.getPosition()));
              },
              ...
              statuschange: function (b) {
                "textedit" == b.lastStatus &&
                  "normal" == b.currentStatus &&
                  a.preventDragMove();
              },
            },
    ...
    (b[46] = {
      value: function (a, c, d) {
        ...
        j.register("Expand", function () {
          ...
          e.extendClass(h, {
            expand: function () {
              return this.setData(b, "expand"), this;
            },
            collapse: function () {
            ...
            isExpanded: function () {
              return (
                this.getData(b) !== c &&
                (this.isRoot() || this.parent.isExpanded())
              );
            },
          ...
          var d = e.createClass("ExpandCommand", {
              base: i,
              execute: function (a, b) {
                var c = a.getSelectedNode();
                if (c) {
                  for (b && (c = c.parent); c.parent; )
                    c.expand(), (c = c.parent);
            ...
            j = e.createClass("ExpandToLevelCommand", {
              base: i,
              execute: function (a, b) {
                a.getRoot().traverse(function (a) {
                  a.getLevel() < b && a.expand(),
                    a.getLevel() != b || a.isLeaf() || a.collapse();
                }),
                  a.refresh(100);
              },
              enableReadOnly: !0,
            }),
            l = e.createClass("CollapseCommand", {
              base: i,
              execute: function (a) {
                var b = a.getSelectedNode();
            ...
            m = e.createClass("Expander", {
              base: e.Group,
              constructor: function (a) {
                this.callBase(),
                  (this.radius = 6),
                  (this.outline = new e.Circle(this.radius)
                    .stroke("gray")
                    .fill("white")),
                  (this.sign = new e.Path().stroke("gray")),
                  this.addShapes([this.outline, this.sign]),
                  this.initEvent(a),
                  this.setId(f.uuid("node_expander")),
              ...
              initEvent: function (b) {
                this.on("mousedown", function (c) {
                  a.select([b], !0),
                    ...
                    b.renderTree().getMinder().layout(100),
                    b.getMinder().fire("contentchange"),
                    c.stopPropagation(),
                    c.preventDefault();
                }),
              ...
              setState: function (a) {
                ...
                a == c &&
                  ...
                  this.sign.setPathData(b);
              },
            }),
            n = e.createClass("ExpanderRenderer", {
              base: k,
              create: function (a) {
                if (!a.isRoot())
                  return (
                    (this.expander = new m(a)),
                    a.getRenderContainer().prependShape(this.expander),
                    (a.expanderRenderer = this),
                    (this.node = a),
                    this.expander
                  );
              },
              ...
              update: function (a, c, d) {
                if (c.parent) {
                  ...
                  var f = c
                      .getLayoutVectorIn()
                      .normalize(a.radius + c.getStyle("stroke-width")),
          ...
          return {
            commands: { expand: d, expandtolevel: j, collapse: l },
            events: {
                ...
                if ("textedit" != this.getStatus()) {
                  if (a.originEvent.keyCode == g["/"]) {
                    ...
                    this.getSelectedNodes().forEach(function (a) {
                      ...
                      a.preventDefault(),
                      a.stopPropagationImmediately();
                  }
                  a.isShortcutKey("Alt+`") &&
                    this.execCommand("expandtolevel", 9999);
                  for (var d = 1; d < 6; d++)
                    a.isShortcutKey("Alt+" + d) &&
                      this.execCommand("expandtolevel", d);
                }
              },
            },
            renderers: { outside: n },
    ...
    (b[47] = {
      value: function (a, c, d) {
        ...
        var f = b.r(17),
          ...
          h = b.r(20);
        b.r(61).registerStyleHook(function (a, b) {
          var c = a.getData("color"),
            ...
            i = e(a, "font-size");
          b.fill(g),
            b.eachItem(function (a, b) {
              b.setFont({ family: h, size: i });
            });
        }),
          h.register("fontmodule", {
            commands: {
              forecolor: f.createClass("fontcolorCommand", {
                base: g,
                execute: function (a, b) {
                  a.getSelectedNodes().forEach(function (a) {
                ...
                queryValue: function (a) {
                  return 1 == a.getSelectedNodes().length
                    ? a.getSelectedNodes()[0].getData("color")
                    : "mixed";
                },
              }),
              background: f.createClass("backgroudCommand", {
                ...
                queryValue: function (a) {
                  return 1 == a.getSelectedNodes().length
                    ? a.getSelectedNodes()[0].getData("background")
                    : "mixed";
                },
              }),
              fontfamily: f.createClass("fontfamilyCommand", {
                base: g,
                execute: function (a, b) {
                  a.getSelectedNodes().forEach(function (c) {
        ...
        g.register("hyperlink", {
          commands: {
            hyperlink: e.createClass("hyperlink", {
              ...
              execute: function (a, b, c) {
                a.getSelectedNodes().forEach(function (a) {
                  a.setData("hyperlink", b),
                    a.setData("hyperlinkTitle", b && c),
                    a.render();
                }),
                  a.layout();
              },
              queryState: function (a) {
                ...
                return 0 === b.length
                  ? -1
                  : (b.forEach(function (a) {
                      if (a && a.getData("hyperlink")) return (c = 0), !1;
                    }),
                    c);
              },
              queryValue: function (a) {
          ...
          renderers: {
            right: e.createClass("hyperlinkrender", {
              ...
              update: function (a, b, c) {
                ...
                a.setHref("#");
                for (
                  var f = ["^http:", "^https:", "^ftp:", "^mailto:"], g = 0;
                  g < f.length;
                  g++
                )
                  if (new RegExp(f[g]).test(d)) {
                    a.setHref(d);
                    break;
                  }
                var h = b.getData("hyperlinkTitle");
                (h = h ? [h, "(", d, ")"].join("") : d),
                ...
                var i = b.getStyle("space-right");
                return (
                  a.setTranslate(c.right + i + 2, -5),
                  new e.Box({ x: c.right + i, y: -11, width: 24, height: 22 })
                );
              },
            }),
          },
    ...
    (b[49] = {
      value: function (a, c, d) {
        ...
        g.register("ImageViewer", function () {
          ...
          var d = e.createClass("ImageViewer", {
            constructor: function () {
              var c = a("button", "km-image-viewer-btn km-image-viewer-close"),
                d = a("button", "km-image-viewer-btn km-image-viewer-source"),
                e = (this.image = a("img")),
                f = (this.toolbar = a("div", "km-image-viewer-toolbar", [
                  d,
                  c,
                ])),
                g = a("div", "km-image-viewer-container", [e]),
                h = (this.viewer = a("div", "km-image-viewer", [f, g]));
              (this.hotkeyHandler = this.hotkeyHandler.bind(this)),
                b(c, "click", this.close.bind(this)),
                b(d, "click", this.viewSource.bind(this)),
                b(e, "click", this.zoomImage.bind(this)),
                b(h, "contextmenu", this.toggleToolbar.bind(this)),
                b(document, "keydown", this.hotkeyHandler);
            },
            dispose: function () {
              this.close(),
            ...
            hotkeyHandler: function (a) {
              this.actived && a.keyCode === f.esc && this.close();
            },
            toggleToolbar: function (a) {
              a && a.preventDefault(), this.toolbar.classList.toggle("hidden");
            },
            zoomImage: function (a) {
              var b = this.image;
              "boolean" == typeof a
                ? a && c(b, "limited")
                : b.classList.toggle("limited");
            },
            viewSource: function (a) {
          ...
          return {
            ...
            events: {
              "normal.dblclick": function (a) {
                var b = a.kityEvent.targetShape;
                "Image" === b.__KityClassName &&
                  b.url &&
                  this.viewer.open(b.url);
              },
            },
          };
        });
          ...
          function b(a, b, c, d) {
            ...
            return (
              a > c && e > f
                ? ((a = c), (b = a / e))
                : b > d && ((b = d), (a = b * e)),
              { width: 0 | a, height: 0 | b }
            );
          }
          return {
            defaultOptions: { maxImageWidth: 200, maxImageHeight: 200 },
            commands: {
              image: e.createClass("ImageCommand", {
                base: f,
                  ...
                  a(d, function (a, g) {
                    f.forEach(function (f) {
                      var h = b(
                        a,
                        g,
                        c.getOption("maxImageWidth"),
                        c.getOption("maxImageHeight")
                      );
                      f.setData("image", d),
                        f.setData("imageTitle", d && e),
                        f.setData("imageSize", d && h),
                        f.render();
                    }),
                      c.fire("saveScene"),
                      c.layout(300);
                ...
                queryState: function (a) {
                  ...
                  return 0 === b.length
                    ? -1
                    : (b.forEach(function (a) {
                        if (a && a.getData("image")) return (c = 0), !1;
                      }),
                      c);
                },
                queryValue: function (a) {
            ...
            renderers: {
              top: e.createClass("ImageRenderer", {
                base: h,
                create: function (a) {
                  ...
                  if (g) {
                    ...
                    return (
                      a
                        ...
                        .setY(0 | j)
                        .setWidth(0 | g.width)
                        .setHeight(0 | g.height),
                      new e.Box(0 | i, 0 | j, 0 | g.width, 0 | g.height)
                    );
                  }
                },
              }),
        ...
        e.register("KeyboardModule", function () {
          ...
          function b(a, b) {
            ...
            (c = e(a.left, b.left)),
              (d = f(a.right, b.right)),
              (h = e(a.top, b.top)),
              (i = f(a.bottom, b.bottom)),
              (j = d - c - a.width - b.width),
              (k = i - h - a.height - b.height),
              (l = j < 0 ? k : k < 0 ? j : g(j * j + k * k));
            var m = a.node,
              n = b.node;
            return (
              m.parent == n.parent && (l /= 10), n.parent == m && (l /= 5), l
            );
          }
          function c(a, c) {
            for (var d, e, f = a[c], g = {}, h = 0; h < a.length; h++)
              h != c &&
                ((d = a[h]),
                (e = b(d, f)),
                d.right < f.left &&
                  (!g.left || e < g.left.dist) &&
                  (g.left = { dist: e, node: d.node }),
                d.left > f.right &&
                  (!g.right || e < g.right.dist) &&
                  (g.right = { dist: e, node: d.node }),
                d.bottom < f.top &&
                  (!g.top || e < g.top.dist) &&
                  (g.top = { dist: e, node: d.node }),
                d.top > f.bottom &&
                  (!g.down || e < g.down.dist) &&
                  (g.down = { dist: e, node: d.node }));
            ...
            events: {
              ...
              "normal.keydown readonly.keydown": function (a) {
                ...
                ["left", "right", "up", "down"].forEach(function (c) {
                  a.isShortcutKey(c) &&
                    (d(b, "up" == c ? "top" : c), a.preventDefault());
                });
              },
            },
          };
      ...
      value: function (a, c, d) {
        var e = b.r(17),
          ...
          i = e.createClass("ResetLayoutCommand", {
            ...
            execute: function (a) {
              var b = a.getSelectedNodes();
              b.length || (b = [a.getRoot()]),
                b.forEach(function (a) {
                  a.traverse(function (a) {
                    a.resetLayoutOffset(),
                      a.isRoot() || a.setData("layout", null);
                  });
                }),
                a.layout(300);
            },
        ...
        g.register("LayoutModule", {
          commands: { layout: h, resetlayout: i },
          contextmenu: [{ command: "resetlayout" }, { divider: !0 }],
          commandShortcutKeys: { resetlayout: "Ctrl+Shift+L" },
        });
      },
    }),
    (b[53] = {
      value: function (a, c, d) {
        var e = b.r(17),
          ...
          i =
            (b.r(27),
            e.createClass("AppendChildCommand", {
              base: g,
              execute: function (a, b) {
                var c = a.getSelectedNode();
                if (!c) return null;
          ...
          j = e.createClass("AppendSiblingCommand", {
            ...
            execute: function (a, b) {
              ...
              e.setGlobalLayoutTransform(c.getGlobalLayoutTransform()),
                a.select(e, !0),
                e.render(),
                a.layout(600);
            },
          ...
          l = e.createClass("AppendParentCommand", {
            ...
            execute: function (a, b) {
              ...
              c.forEach(function (a) {
                ...
                e.setGlobalLayoutTransform(
                  c[c.length >> 1].getGlobalLayoutTransform()
                ),
                a.select(e, !0),
                a.layout(600);
            },
    ...
    (b[54] = {
      value: function (a, c, d) {
        ...
        g.register("NoteModule", function () {
            ...
            c = e.createClass("NoteIcon", {
              ...
              constructor: function () {
                this.callBase(),
                  (this.width = 16),
                  (this.height = 17),
                  (this.rect = new e.Rect(16, 17, 0.5, -8.5, 2).fill(
                    "transparent"
                  )),
                  (this.path = new e.Path()
                    .setPathData(a)
                    .setTranslate(2.5, -6.5)),
          ...
          return {
            renderers: {
              right: e.createClass("NoteIconRenderer", {
                base: h,
                create: function (a) {
                  var b = new c();
                  return (
                ...
                update: function (a, b, c) {
                  var d = c.right + b.getStyle("space-left"),
                    f = c.cy;
                  return (
                    a.path.fill(b.getStyle("color")),
                    a.setTranslate(d, f),
                    new e.Box(
                      d,
                      Math.round(f - a.height / 2),
                      a.width,
                      a.height
                    )
                  );
          ...
          i = e.createClass("OutlineRenderer", {
            ...
            update: function (a, b, c) {
              ...
              if (d && "circle" == d) {
                var l = Math.pow;
                (k = (0, Math.round)(
                  Math.sqrt(l(j.width, 2) + l(j.height, 2)) / 2
                )),
                  (j.x = c.cx - k),
                  (j.y = c.cy - k),
                  (j.width = 2 * k),
              ...
              return (
                a
                  ...
                  .setRadius(k)
                  .fill(
                    b.getData("background") ||
                      b.getStyle(m + "background") ||
                      b.getStyle("background")
                  )
                  .stroke(
                    b.getStyle(m + "stroke" || b.getStyle("stroke")),
                    b.getStyle(m + "stroke-width")
                  ),
                new e.Box(j)
              );
            },
          ...
          j = e.createClass("ShadowRenderer", {
            ...
            update: function (a, b, c) {
              ...
              if (d) {
                ...
                a.setSize(c.width, c.height), a.setRadius(b.getStyle("radius"));
            },
          }),
          k = new e.Marker();
        k.setWidth(10),
          k.setHeight(12),
          k.setRef(0, 0),
          k.setViewBox(-6, -4, 8, 10),
          k.addShape(
            new e.Path().setPathData("M-5-3l5,3,-5,3").stroke("#33ffff")
          );
        var l = /wire/.test(window.location.href),
          m = e.createClass("WireframeRenderer", {
            ...
            update: function (a, b, c) {
              ...
              this.vectorIn.setPathData(["M", d.offset(f.reverse()), "L", d]),
                this.vectorOut.setPathData(["M", e, "l", g]);
            },
          });
          ...
          return {
            events: l
              ? {
                  ...
                  layoutallfinish: function () {
                    this.getRoot().traverse(function (a) {
                      a.getRenderer("WireframeRenderer").update(
                        null,
                        a,
                        a.getContentBox()
                      );
              ...
              : null,
            renderers: { outline: i, outside: [j, m] },
          };
        });
      },
    }),
    (b[56] = {
      value: function (a, c, d) {
        ...
        h.register("PriorityModule", function () {
            ...
            h = e.createClass("PriorityIcon", {
              ...
              constructor: function () {
                this.callBase(),
                  this.setSize(20),
                  this.create(),
                  this.setId(f.uuid("node_priority"));
              },
              setSize: function (a) {
              ...
              create: function () {
                var a, d, f;
                new e.Path().setPathData(c).fill("white"),
                  (a = new e.Path().setPathData(b).setTranslate(0.5, 0.5)),
                  (d = new e.Path()
                    .setPathData(c)
                    .setOpacity(0.8)
          ...
          return {
            commands: {
              priority: e.createClass("SetPriorityCommand", {
                base: g,
                execute: function (a, b) {
                  for (var c = a.getSelectedNodes(), e = 0; e < c.length; e++)
                    c[e].setData(d, b || null).render();
                  a.layout();
                },
                queryValue: function (a) {
                  for (
                    var b, c = a.getSelectedNodes(), e = 0;
                    e < c.length && !(b = c[e].getData(d));
                    e++
                  );
                  return b || null;
                },
              ...
              left: e.createClass("PriorityRenderer", {
                ...
                update: function (a, b, c) {
                  ...
                  return (
                    ...
                    (g = -a.height / 2),
                    a.setTranslate(f, g),
                    new e.Box({ x: f, y: g, width: a.width, height: a.height })
                  );
                },
              }),
            },
        ...
        h.register("ProgressModule", function () {
          var a = this,
            ...
            l = new e.LinearGradient().pipe(function (a) {
              a.setStartPosition(0, 0),
                a.setEndPosition(0, 1),
                a.addStop(0, "#fff"),
                a.addStop(1, "#ccc");
            }),
            m =
          ...
          var o = e.createClass("ProgressIcon", {
            ...
            constructor: function (a) {
              this.callBase(),
                ...
                this.create(),
                this.setValue(a),
                this.setId(f.uuid("node_progress")),
            ...
            create: function () {
              var a, b, f, g, i;
              (a = new e.Circle(9).fill(c)),
                (b = new e.Pie(9, 0).fill(d)),
                (f = new e.Path()
                  .setPathData(h)
                  .setTranslate(-10, -10)
                  .fill(j)),
                ...
                (i = new e.Path()
                  ...
                  .setPathData(m)
                  .fill(n)),
                this.addShapes([a, b, f, i, g]),
                (this.pie = b),
                (this.check = i);
            },
            setValue: function (a) {
              this.pie.setAngle((-360 * (a - 1)) / 8),
                this.check.setVisible(9 == a);
            },
          });
          return {
            commands: {
              progress: e.createClass("ProgressCommand", {
                base: g,
                execute: function (a, c) {
                  for (var d = a.getSelectedNodes(), e = 0; e < d.length; e++)
                    d[e].setData(b, c || null).render();
                  a.layout();
                },
                queryValue: function (a) {
                  for (
                    var c, d = a.getSelectedNodes(), e = 0;
                    e < d.length && !(c = d[e].getData(b));
                    e++
                  );
                  return c || null;
                },
              ...
              left: e.createClass("ProgressRenderer", {
                ...
                update: function (a, c, d) {
                  ...
                  return (
                    ...
                    (f = d.left - a.width - i),
                    (g = -a.height / 2),
                    a.setTranslate(f + a.width / 2, g + a.height / 2),
                    new e.Box(f, g, a.width, a.height)
                  );
                },
              }),
            },
        ...
        h.register("Resource", function () {
          var a = (function () {
              ...
              return (
                ...
                (j = function (a) {
                  return (
                    a < 0 && (a += k), ("00000000" + a.toString(16)).slice(-8)
                  );
                }),
                (f = [
                ...
                function (f, g) {
                  ...
                  var k, l, m, n, o, p, q, r;
                  for (l = a.slice(0), k = e.slice(0, 8), c = 0; c < 4; c += 1)
                    k[c] ^= g[c];
                  if (
                    ((m = 16 * f.length),
                    (o = m % 512 > 446 || m % 512 == 0 ? 0 : m),
                    m % 512 == 432)
                  )
                    f += "老";
                  else {
                    for (f += "耀"; f.length % 32 != 27; ) f += "\0";
                    f += "";
                  }
                  for (i = [], r = 0; r < f.length; r += 2)
                    i.push(65536 * f.charCodeAt(r) + f.charCodeAt(r + 1));
                  for (
                    i.push(0), i.push(m), p = i.length - 16, q = 0, d = 0;
                    d < i.length;
                    d += 16
                  ) {
                    for (
                      q += 512,
                        n = d === p ? o : Math.min(m, q),
                        h = l.concat(k),
                        h[12] ^= n,
                        h[13] ^= n,
                        c = 0;
                      ...
                      for (r = 0; r < 8; r += 1)
                        r < 4 ? b(r, r, r, r, r) : b(r, r, r + 1, r + 2, r + 3);
                    for (r = 0; r < 8; r += 1)
                      l[r] ^= g[r % 4] ^ h[r] ^ h[r + 8];
                  }
                  return l.map(j).join("");
          ...
          e.extendClass(f, {
            getHashCode: function (b) {
              ...
              for (c = b.length - 1; c >= 0; c--)
                (d = b.charCodeAt(c)), (e ^= (e << 5) + d + (e >> 2));
              return 2147483647 & e;
            },
            getResourceColor: function (a) {
              var c,
                d = this._getResourceColorIndexMapping();
              return (
                Object.prototype.hasOwnProperty.call(d, a) ||
                  ((c = this._getNextResourceColorIndex()), (d[a] = c)),
                b[d[a]] ||
                  e.Color.createHSL(
                    Math.floor((this.getHashCode(a) / 2147483647) * 359),
                    100,
                    85
                  )
              );
            ...
            getUsedResource: function () {
              var a,
                b = this._getResourceColorIndexMapping(),
                c = [];
              for (a in b)
            ...
            _getNextResourceColorIndex: function () {
              var a,
                c,
                d,
                e = this._getResourceColorIndexMapping();
              c = [];
              for (a in e)
                Object.prototype.hasOwnProperty.call(e, a) && c.push(e[a]);
              for (d = 0; d < b.length; d++) if (!~c.indexOf(d)) return d;
              return -1;
            },
            _getResourceColorIndexMapping: function () {
              return (
                this._resourceColorMapping || (this._resourceColorMapping = {})
              );
            },
          });
          var c = e.createClass("ResourceCommand", {
            ...
            d = e.createClass("ResourceOverlay", {
              ...
              constructor: function () {
                this.callBase();
                var a, b;
                (b = this.rect = new e.Rect().setRadius(4)),
                  (a = this.text =
                    new e.Text().setFontSize(12).setVerticalAlign("middle")),
                  this.addShapes([b, a]);
              },
              setValue: function (a, b) {
                var c,
                  ...
                  g = 4;
                (c = this.text),
                  a == this.lastResourceName
                    ? (d = this.lastBox)
                    : (c.setContent(a),
                      (d = c.getBoundaryBox()),
                      (this.lastResourceName = a),
                      (this.lastBox = d)),
                  c.setX(f).fill(b.dec("l", 70)),
                  (e = this.rect),
                  e.setPosition(0, d.y - g),
                  (this.width = Math.round(d.width + 2 * f)),
                  (this.height = Math.round(d.height + 2 * g)),
          ...
          return {
            commands: { resource: c },
            renderers: {
              right: e.createClass("ResourceRenderer", {
                base: i,
                create: function (a) {
                ...
                update: function (a, b, c) {
                  ...
                  if (0 !== h.length) {
                    var i,
                      ...
                      k,
                      l = b.getMinder();
                    for (k = 0, i = 0; i < h.length; i++)
                      (k += f),
                        (j = g[i]),
                        j || ((j = new d()), g.push(j), a.addShape(j)),
                        j.setVisible(!0),
                        j.setValue(h[i], l.getResourceColor(h[i])),
                        j.setTranslate(k, -1),
                        (k += j.width);
                    for (; (j = g[i++]); ) j.setVisible(!1);
                    return (
                      a.setTranslate(c.right, 0),
                      new e.Box({
                        x: c.right,
            ...
            c = (function () {
              ...
              return {
                selectStart: function (a) {
                  if (!a.originEvent.button && !a.originEvent.altKey)
                    return c
                      ? this.selectEnd()
                      : void (c = a.getPosition(b).round());
                },
                selectMove: function (g) {
                  if ("textedit" != a.getStatus() && c) {
                    var h = c,
                      i = g.getPosition(b);
                    if (!f) {
                      if (e.Vector.fromPoints(h, i).length() < 10) return;
                      (f = !0),
                        b.addShape(d),
                        d
                          .fill(a.getStyle("marquee-background"))
                          .stroke(a.getStyle("marquee-stroke"))
                          .setOpacity(0.8)
                          .getDrawer()
                          .clear();
                    }
                    var j = new e.Box(h.x, h.y, i.x - h.x, i.y - h.y),
                      k = [];
                    (j.left = Math.round(j.left)),
                      (j.top = Math.round(j.top)),
                      (j.right = Math.round(j.right)),
                      (j.bottom = Math.round(j.bottom)),
                      d.getDrawer().pipe(function () {
                        this.clear(),
                          this.moveTo(j.left, j.top),
                          this.lineTo(j.right, j.top),
                          this.lineTo(j.right, j.bottom),
                          this.lineTo(j.left, j.bottom),
                          this.close();
                      }),
                      a.getRoot().traverse(function (a) {
                        a.getLayoutBox().intersect(j).isEmpty() || k.push(a);
                      }),
                      a.select(k, !0),
          ...
          return {
            ...
            events: {
              mousedown: function (a) {
                ...
                b
                  ? a.isShortcutKey("Ctrl")
                    ? this.toggleSelect(b)
                    : b.isSelected()
                    ? this.isSingleSelect() || ((d = b), (f = a.getPosition()))
                    : this.select(b, !0)
              ...
              mouseup: function (a) {
                ...
                if (b && b == d) {
                  var g = a.getPosition();
                  e.Vector.fromPoints(f, g).length() < 1 && this.select(d, !0),
                    (d = null);
                }
                c.selectEnd(a);
              },
            ...
            commands: {
              ...
              pastestyle: e.createClass("PastStyleCommand", {
                ...
                execute: function (a) {
                  return (
                    a.getSelectedNodes().forEach(function (a) {
                      for (var b in c)
                        c.hasOwnProperty(b) && a.setData(b, c[b]);
                    }),
                    a.renderNodeBatch(a.getSelectedNodes()),
                    a.layout(300),
                    c
                  );
                },
              ...
              clearstyle: e.createClass("ClearStyleCommand", {
                ...
                queryState: function (b) {
                  ...
                  for (var d = 0; d < c.length; d++) if (a(c[d])) return 0;
                  return -1;
                },
              }),
            },
          ...
          l = e.createClass("TextRenderer", {
            ...
            update: function (a, b) {
              ...
              var d,
                ...
                m = -l / 2,
                n = e.Browser;
              n.chrome || n.opera || n.bd || "chrome" === n.lb
                ? (d = k.chrome[n.platform][j])
                : n.gecko
                ? (d = k.firefox[n.platform][j])
                : n.sg
                ? (d = k.sg[j])
                : n.safari
                ? (d = k.safari[j])
              ...
              var q,
                ...
                u = g.length,
                v = a.getItems().length;
              if (u < v) for (q = u, r; (r = a.getItem(q)); ) a.removeItem(q);
              else if (u > v)
                for (var w = u - v; w--; )
                  (s = new e.Text().setAttr("text-rendering", "inherit")),
                    e.Browser.ie || e.Browser.edge
                      ? s.setVerticalAlign("top")
                      : s.setAttr("dominant-baseline", "text-before-edge"),
                    a.addItem(s);
              for (q = 0, s; (t = g[q]), (s = a.getItem(q)); q++)
                s.setContent(t),
                  (e.Browser.ie || e.Browser.edge) && s.fixPosition();
              this.setTextStyle(b, a);
              var x =
                b.getText() +
                ["font-size", "font-name", "font-weight", "font-style"]
                  .map(c)
                  .join("/");
              return b._currentTextHash == x && b._currentTextGroupBox
                ? b._currentTextGroupBox
                : ((b._currentTextHash = x),
                  function () {
                    a.eachItem(function (a, b) {
                      ...
                      o = o.merge(
                        new e.Box(0, c, (d.height && d.width) || 1, i)
                      );
                    });
            ...
            setTextStyle: function (a, b) {
              l._styleHooks.forEach(function (c) {
                c(a, b);
              });
            },
          }),
      ...
      value: function (a, c, d) {
          ...
          h =
            ...
            e.createClass("ViewDragger", {
              ...
              setEnabled: function (a) {
                ...
                b.setStyle("cursor", a ? "pointer" : "default"),
                  b.setStyle("cursor", a ? "-webkit-grab" : "default"),
                  (this._enabled = a);
              },
              timeline: function () {
              ...
              moveTo: function (a, b) {
                if (b) {
                  var c = this;
                  return (
                    this._moveTimeline && this._moveTimeline.stop(),
                    (this._moveTimeline = this._minder
                      .getRenderContainer()
                      .animate(
                        new e.Animator(this.getMovement(), a, function (a, b) {
                          c.moveTo(b);
                        }),
                        b,
                        "easeOutCubic"
                ...
                this._minder.getRenderContainer().setTranslate(a.round()),
              ...
              _bind: function () {
                  ...
                  if (d) {
                    (d = null),
                      ...
                      c &&
                        (b.setEnabled(!1),
                        (c = !1),
                        "hand" == b._minder.getStatus() &&
                          b._minder.rollbackStatus());
                    b._minder
                      .getPaper()
                      .setStyle(
                        "cursor",
                ...
                this._minder
                  .on(
                    "normal.mousedown normal.touchstart inputready.mousedown inputready.touchstart readonly.mousedown readonly.touchstart",
                    function (a) {
                      2 == a.originEvent.button &&
                        a.originEvent.preventDefault(),
                        (a.getTargetNode() == this.getRoot() ||
                          2 == a.originEvent.button ||
                          a.originEvent.altKey) &&
                          ((d = a.getPosition("view")), (c = !0));
                    }
                  )
                  .on(
                    "normal.mousemove normal.touchmove readonly.mousemove readonly.touchmove inputready.mousemove inputready.touchmove",
                    function (a) {
                      if (("touchmove" == a.type && a.preventDefault(), c)) {
                        if (
                          ...
                          b._minder
                            .getPaper()
                            .setStyle("cursor", "-webkit-grabbing");
                        }
                      }
                    }
                  )
                  ...
                  this._minder.on("contextmenu", function (a) {
                    a.preventDefault();
                  });
              },
            }));
        g.register("View", function () {
          ...
          return {
            ...
            commands: { hand: a, camera: b, move: c },
            events: {
              ...
              mousewheel: function (a) {
                ...
                if (((a = a.originEvent), !a.ctrlKey && !a.shiftKey)) {
                  "wheelDeltaX" in a
                    ? ((b = a.wheelDeltaX || 0), (c = a.wheelDeltaY || 0))
                    : ((b = 0), (c = a.wheelDelta)),
                    this._viewDragger.move({ x: b / 2.5, y: c / 2.5 });
                  var d = this;
              ...
              "normal.dblclick readonly.dblclick": function (a) {
                a.kityEvent.targetShape instanceof e.Paper &&
              ...
              resize: function (a) {
                ...
                this._viewDragger.move(
                  new e.Point(
                    ((b.width - c.width) / 2) | 0,
                    ((b.height - c.height) / 2) | 0
                  )
                ),
                  (this._lastClientSize = b);
              },
              "selectionchange layoutallfinish": function (a) {
                ...
                if ((e.Browser.edge && this.fire("paperrender"), b)) {
                  var d = this._viewDragger,
                    f = d.timeline();
                  if (f)
                    return void f.on("finish", function () {
                  ...
                  h.right > g.right
                    ? (j += g.right - h.right - i)
                    : h.left < g.left && (j += g.left - h.left + i),
                    h.bottom > g.bottom && (k += g.bottom - h.bottom - i),
                    h.top < g.top && (k += g.top - h.top + i),
                    (j || k) && d.move(new e.Point(j, k), 100);
                }
              },
            },
          };
    ...
    (b[63] = {
      value: function (a, c, d) {
        ...
        h.register("Zoom", function () {
          function a() {
            var a =
              h._zoomValue >= 100 ? "optimize-speed" : "geometricPrecision";
          ...
          function c(b, c) {
            ...
            if (c) {
              ...
              if (b.getRoot().getComplex() > 200 || !g)
                (b._zoomValue = c), b.zoom(c), b.fire("viewchange");
              else {
          ...
          e.extendClass(f, {
            zoom: function (a) {
              var c = this.getPaper(),
                d = c.getViewPort();
              (d.zoom = a / 100),
                (d.center = { x: d.center.x, y: d.center.y }),
                c.setViewPort(d),
                100 == a && b(c);
            },
          ...
          return {
            init: function () {
              (this._zoomValue = 100),
                this.setDefaultOptions({ zoom: [10, 20, 50, 100, 200] }),
                a();
            },
            commands: { zoomin: j, zoomout: k, zoom: i },
            events: {
                  ...
                  e.Browser.mac || (b = -b),
                    Math.abs(b) > 100 &&
                      ...
                      (this._wheelZoomTimeout = setTimeout(function () {
                        c.getPaper()._zoom;
                        b < 0
                          ? c.execCommand("zoomin")
                          : b > 0 && c.execCommand("zoomout");
                      }, 100)),
                      a.originEvent.preventDefault());
                }
              },
    ...
    (b[66] = {
      value: function (a, c, d) {
        ...
        function f(a, b) {
          return k(function (b, c) {
            var d = new XMLHttpRequest();
            d.open("GET", a.url + "?_=" + Date.now(), !0),
              (d.responseType = "blob"),
              (d.onreadystatechange = function () {
                if (4 === d.readyState && 200 === d.status) {
                  var c = d.response,
                    e = document.createElement("img");
                  (e.src = l.createObjectURL(c)),
                    (e.onload = function () {
          ...
          function b(c) {
            ...
            if (d.image) {
              ...
              var d = c.data,
                e = d.image,
                f = d.imageSize,
                g = c.getRenderBox("ImageRenderer", a.getRenderContainer()),
                h = {
                  url: e,
                  width: f.width,
                  height: f.height,
                  x: -j.getBoundaryBox().x + g.x,
                  y: -j.getBoundaryBox().y + g.y,
                };
              o.push(h);
            }
            if ("collapse" !== d.expandState)
              for (var i = c.getChildren(), k = 0; k < i.length; k++) b(i[k]);
          }
          var c,
            d,
            e,
            ...
            h,
            i = a.getPaper(),
            j = (i.container, a.getRenderContainer()),
            k = j.getRenderBox(),
            m = k.width + 1,
            n = k.height + 1;
          (c = i.shapeNode.getAttribute("transform")),
            i.shapeNode.setAttribute("transform", "translate(0.5, 0.5)"),
            j.translate(-k.x, -k.y),
            (d = i.container.innerHTML),
            j.translate(k.x, k.y),
            i.shapeNode.setAttribute("transform", c),
            (e = document.createElement("div")),
            (e.innerHTML = d),
            (f = e.querySelector("svg")),
            f.setAttribute("width", k.width + 1),
            f.setAttribute("height", k.height + 1),
            f.setAttribute(
              "style",
            ...
            (d = d.replace(/&nbsp;|[\x00-\x1F\x7F-\x9F]/g, "")),
            (d = d.replace(/NS\d+:title/gi, "xlink:title")),
            (g = new Blob([d], { type: "image/svg+xml" })),
            (h = l.createObjectURL(g));
          var o = [];
          return (
            b(a.getRoot()),
            { width: m, height: n, dataUrl: h, xml: d, imagesInfo: o }
          );
        }
        function h(a, b, c) {
          function d(a, b) {
          ...
          function h(a, b, c, d, e, f) {
            e && f
              ? a.drawImage(b, c + A, d + A, e, f)
              : a.drawImage(b, c + A, d + A);
          }
          function j(a) {
          ...
          function n() {
            return e({ url: y })
              .then(function (a) {
                return h(p, a.element, w, x, a.width, a.height), m(z);
              })
              .then(
                function (a) {
          ...
          var o = document.createElement("canvas"),
            p = o.getContext("2d"),
            q = b.getStyle("background").toString(),
            r = /url\(\"(.+)\"\)/.exec(q),
            s = i.Color.parse(q),
            t = g(b),
            u = c && c.width && c.width > t.width ? c.width : t.width,
            v = c && c.height && c.height > t.height ? c.height : t.height,
            w = c && c.width && c.width > t.width ? (c.width - t.width) / 2 : 0,
            x =
              c && c.height && c.height > t.height
                ? (c.height - t.height) / 2
                : 0,
            y = t.dataUrl,
            z = t.imagesInfo,
          ...
          if (((o.width = u + 2 * A), (o.height = v + 2 * A), r)) {
            return e({ url: r[1] }).then(function (a) {
              return d(p, p.createPattern(a.element, "repeat")), n();
            });
          }
          return d(p, s.toString()), n();
        }
        var i = b.r(17),
          j = b.r(12),
          k = b.r(25),
      ...
      value: function (a, c, d) {
        function e(a, b, c) {
          ...
          function f(a, b, c) {
            if (a && "defs" !== a.tagName) {
              if (
                ("transparent" === a.getAttribute("fill") &&
                  a.setAttribute("fill", "none"),
                a.getAttribute("marker-end") && a.removeAttribute("marker-end"),
                (b = b || 0),
                (c = c || 0),
              ...
              switch (a.tagName.toLowerCase()) {
                ...
                case "text":
                  ...
                  return (
                    a.getAttribute("dominant-baseline") &&
                      (a.removeAttribute("dominant-baseline"),
                      a.setAttribute("dy", ".8em")),
                    void a.removeAttribute("transform")
                  );
              }
              if (a.children)
                for (var k = 0, l = a.children.length; k < l; k++)
                  f(a.children[k], b, c);
            }
          }
          ...
          (d.exports = {
            ...
            encode: function (a, b) {
              var c,
                ...
                m = 20;
              return (
                g.shapeNode.setAttribute("transform", "translate(0.5, 0.5)"),
                (c = g.container.innerHTML),
                g.shapeNode.setAttribute("transform", h),
                (d = document.createElement("div")),
                document.body.appendChild(d),
                (d.innerHTML = c),
                (f = d.querySelector("svg")),
                f.setAttribute("width", (k + 2 * m) | 0),
                f.setAttribute("height", (l + 2 * m) | 0),
                f.setAttribute(
                  "style",
                  "background: " + b.getStyle("background")
                ),
                f.setAttribute(
                  "viewBox",
                  [0, 0, (k + 2 * m) | 0, (l + 2 * m) | 0].join(" ")
                ),
                (tempSvgContainer = document.createElement("div")),
                e(f, (j.x - m) | 0, (j.y - m) | 0),
                document.body.removeChild(d),
                tempSvgContainer.appendChild(f),
                (c = tempSvgContainer.innerHTML),
                (c = c.replace(/&nbsp;/g, "&#xa0;"))
              );
            },
          })
    ...
    (b[68] = {
      value: function (a, c, d) {
        ...
        function j(a) {
          for (var b = 0; r.REGEXP.test(a); )
            (a = a.replace(r.REGEXP, "")), b++;
          return b;
        }
        function k(a) {
          return { data: { text: g(a.replace(r.DELETE, "")) } };
        }
        function l(a) {
          function b(a, b) {
            (a.children || (a.children = [])).push(b);
          }
        ...
        function m(a) {
          ...
          if (a)
            return (
              /^\s*$/.test(a.data.text) && (a.data.text = "分支主题"), h(b(a))
            );
        }
        var n = b.r(12),
          o = b.r(17).Browser,
          ...
          r = (function (a) {
            return a.gecko
              ? {
                  REGEXP: new RegExp(
                    "^(\t|" + String.fromCharCode(160, 160, 32, 160) + ")"
                  ),
                  DELETE: new RegExp(
                    "^(\t|" + String.fromCharCode(160, 160, 32, 160) + ")+"
                  ),
    ...
    (b[70] = {
      value: function (a, c, d) {
        b.r(31).register("filetree", {
          getLayout: function (a) {
            return a.getData("layout")
              ? a.getData("layout")
              : a.isRoot()
              ? "bottom"
              : "filetree-down";
      ...
      value: function (a, c, d) {
        ...
        function f(a, b) {
          return {
            ...
            "marquee-background": e(a, 100, 80).set("a", 0.1),
            "marquee-stroke": e(a, 37, 60),
            "drop-hint-color": e(a, 26, 35),
            "drop-hint-width": 5,
            "order-hint-area-color": e(a, 100, 30).set("a", 0.5),
        ...
        for (g in j)
          i.register("fresh-" + g, f(j[g])),
            i.register("fresh-" + g + "-compat", f(j[g], !0));
      },
    }),
    (b[78] = {
      value: function (a, c, d) {
