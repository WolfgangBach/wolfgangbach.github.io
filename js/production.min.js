function setHasTouch() {
  (hasTouch = !0), window.removeEventListener("touchstart", setHasTouch);
  var a = window,
    b = document,
    c = b.documentElement,
  ...
  jQuery(function (a) {
    function b() {
      ...
      if (n.hasClass("toggled"))
        n.removeClass("toggled"),
          ...
          setTimeout(function () {
            o.removeAttr("style"), t.removeAttr("style");
          }, 400);
      else {
        {
          o.width();
    ...
    function e() {
      if (r.hasClass("secondary-toggle"))
        r.removeClass("secondary-toggle"),
          a("#main, #title-info, #toggle-navigation, #site-footer").css(
            "transform",
            "translateY(0)"
          ),
          r.css("height", "auto");
    ...
    function f() {
      if (r.hasClass("search-open"))
        r.removeClass("search-open"), a("#search-icon").css("left", 0);
      else {
        r.addClass("search-open");
        var b = 0.0555 * r.width(),
          c = n.find(".search-form").width();
        a("#search-icon").css("left", -c + b - 5);
      }
    }
    function g() {
      a(".featured-image").width() < a(".featured-image-container").width()
        ? a(".featured-image-container").css("padding-bottom", 48)
        : a(".featured-image-container").css("padding-bottom", 0);
    }
    function h() {
      a("html").hasClass("ie9") &&
        (r.hasClass("full-width-images") || r.hasClass("two-column-images")) &&
        a(".excerpt-container").each(function () {
          var b = a(this),
    ...
    function i() {
      a(".lazy").each(function () {
        var b = a(this).offset().top,
          ...
          e = d > b - c - 100;
        e &&
          (a(this).hasClass("lazy-image") &&
            a(this)
              .attr("src", a(this).attr("data-src"))
              .removeClass("lazy-image"),
          a(this).hasClass("lazy-bg-image") &&
            a(this)
              .css(
                "background-image",
                'url("' + a(this).attr("data-background") + '")'
              )
              .removeClass("lazy-bg-image"));
      });
    }
    function j() {
      var b = n.find(".logo");
    ...
    function k() {
      window.innerWidth > 899 &&
        r.hasClass("standard") &&
        a(".excerpt.has-video").each(function () {
    ...
    function m() {
      if (
        window.innerWidth > 899 &&
        (r.hasClass("two-column") || r.hasClass("two-column-images"))
      ) {
        ...
        var b = s.find(".excerpt"),
          c = 1;
        b.each(function () {
          if (a(this).hasClass("sorted")) return void c++;
          if (
            (a(this).addClass("sorted"),
    ...
    d(),
      ...
      a(window).on("resize", function () {
        g(),
          ...
          window.innerWidth > 799 &&
            a("#site-header").hasClass("toggled") &&
            b();
      }),
      a(".entry-content, .excerpt-content").fitVids({
        customSelector:
          'iframe[src*="dailymotion.com"], iframe[src*="slideshare.net"], iframe[src*="animoto.com"], iframe[src*="blip.tv"], iframe[src*="funnyordie.com"], iframe[src*="hulu.com"], iframe[src*="ted.com"], iframe[src*="wordpress.tv"]',
      }),
      a(".featured-video").fitVids({
        customSelector:
          'iframe[src*="dailymotion.com"], iframe[src*="slideshare.net"], iframe[src*="animoto.com"], iframe[src*="blip.tv"], iframe[src*="funnyordie.com"], iframe[src*="hulu.com"], iframe[src*="ted.com"], iframe[src*="vine.co"], iframe[src*="wordpress.tv"], iframe[src*="soundcloud.com"], iframe[src*="wistia.net"]',
      }),
      ...
      a(window).scroll(function () {
        a(this).scrollTop() >= 600
          ? a("#return-top").addClass("visible")
          : a("#return-top").removeClass("visible");
      }),
    ...
    a(window).scroll(function () {
      v.allow && (i(), (v.allow = !1), setTimeout(v.reallow, v.delay));
    });
  });
var hasTouch;
  ...
  (function (a) {
    ...
    function f(a, b) {
      ...
      if (a && a.getAttribute(H)) b(a);
        ...
        for (
          e = a ? a.getElementsByTagName("input") : p,
    ...
    if (((S.nativeSupport = void 0 !== P.placeholder), !S.nativeSupport)) {
      for (
        ...
        (z = B < p.length ? p[B] : q[B - p.length]),
          ...
          w && ((w = w.nodeValue), w && T.inArray(C, z.type) && o(z));
